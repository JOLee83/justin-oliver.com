    ...
    return (
      <AboutDiv className="about">
        ...
        <div className="about-card">
          <h1>About Me</h1>
          <div className="text">
            <p className="firstP" onLoad={this._setHeight}>
            ...
            <div className={this.state.ReadMore ? "unfaded" : "faded"}>
              ...
              <p>
                Since arriving in Seattle, I have gained experience and grown as a front-end engineer. My first job as a front-end engineer was working as a subcontractor for Stackend Solutions (a SaaS company for startups). During my time at Stackend Solutions, I worked on and even led the front-end development for multiple clients. The first project I led was rebuilding a client's web page as a React app then connecting their Firebase backend from the iOS app they had already launched. I also led the initial build of frontend of a React Native app that would serve as a concierge app for a startup based in Chicago. I next took a full time position as the primary front-end developer for pubGENIUS (an ad tech startup that offers ad ops as a service). My time at pubGENIUS was primarily spent working on internal and external web apps for managing ad stacks. The apps were built with TypeScript, using React, Node, Redux, MySQL, along with various packages. Although my title was front-end developer at pubGENIUS I was involved in back-end development as well; this mostly involved connecting the front end and making additions to and changing the apps services, routes, and database when needed. I next landed at Microsoft as a Software Design Engineer for Universal Human Relevance System (UHRS). During my time at Microsoft I worked on a new version on UHRS, translating the existing UI built with CS# Razor Pages to modern PWA using Typescript and React. Currently I am a Software Engineer at Seekout, a HR tech company based in Bellevue. I started as a Software Engineer 2 and the primary frontend engineer for the platform team. Now as a Senior Software Engineer I continue to use AI tools to help the company bring AI powered recruiter tools to enterprise customers.
              </p>

              <p>
                During my time working as a software engineer, I have gained an in-depth understanding of the various languages, frameworks, and technologies, along with computer science fundamentals. I am looking forward to continuing my journey of learning and growing as a software engineer.
              </p>
