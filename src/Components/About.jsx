    ...
    return (
      <AboutDiv className="about">
        ...
        <div className="about-card">
          <h1>About Me</h1>
          <div className="text">
            <p className="firstP" onLoad={this._setHeight}>A Web Developer from Florida, currently living in the Greater Seattle Area. Looking for my next challenge, along with ways to get involved and give back to the local developer community.</p>
