    ...
    return (
      <ContactDiv className="contact">
        <div className="back">
          ...
          <p>
            You can also follow and join me on these great platforms.
				  </p>
          <div className="contact-cards">
            <div className="contact-card">
              <a
            ...
            <div className="contact-card">
              <a
                className="contact-link"
                href="https://www.meetup.com/members/262768512/"
                target="_blank"
                rel="noopener noreferrer"
                tabIndex="9"
              >
